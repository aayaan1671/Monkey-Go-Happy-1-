...
function preload(){
  monkey_running = loadAnimation("monkey_0.png","monkey_1.png", "monkey_2.png" ,"monkey_3.png" ,"monkey_4.png",   
"monkey_5.png", "monkey_6.png" ,"monkey_7.png",            "monkey_8.png")  
                                 
                                 
    
  
  monkeyCollide =loadAnimation("monkey_2.png");
...
function setup(){
 createCanvas(600,300);
  ...
  invisiGround = createSprite(300,278,600,5);
